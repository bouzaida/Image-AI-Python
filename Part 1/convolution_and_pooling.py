...
figure.savefig('/home/souheil/Image-AI-Python/Part 1/plot_convolution_and_pooling.png')

# Giving name to the window with figure
figure.canvas.manager.set_window_title('Convolution and Pooling to GRAY image')
